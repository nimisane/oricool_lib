...
enum Masks: String, CaseIterable {
    case original_fit_brown
    case original_fit_yellow
    case original_fit_blue
    case original_fit_pink
    case original_fit_black
    case original_fit_white
    case loose_top_brown
    case loose_top_yellow
    case loose_top_blue
    case loose_top_pink
    case loose_top_black
    case loose_top_white
    case loose_bottom_brown
    case loose_bottom_yellow
    case loose_bottom_blue
    case loose_bottom_pink
    case loose_both_gray
    case loose_bottom_white
    case loose_both_brown
    case loose_both_yellow
    case loose_both_blue
    case loose_both_pink
    case loose_both_black
    case loose_both_white
    case none
    case aviators
    case bigmouth
    case dalmatian
