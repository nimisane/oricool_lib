...
class CameraDeepAr extends StatefulWidget {
  ...
  const CameraDeepAr(
      ...
      this.supportedMasks = const [
        Masks.original_fit_brown,
        Masks.original_fit_yellow,
        Masks.original_fit_blue,
        Masks.original_fit_pink,
        Masks.original_fit_black,
        Masks.original_fit_white,
        Masks.loose_top_brown,
        Masks.loose_top_yellow,
        Masks.loose_top_blue,
        Masks.loose_top_pink,
        Masks.loose_top_black,
        Masks.loose_top_white,
        Masks.loose_bottom_brown,
        Masks.loose_bottom_yellow,
        Masks.loose_bottom_blue,
        Masks.loose_bottom_pink,
        Masks.loose_bottom_black,
        Masks.loose_bottom_white,
        Masks.loose_both_brown,
        Masks.loose_both_yellow,
        Masks.loose_both_blue,
        Masks.loose_both_pink,
        Masks.loose_both_gray,
        Masks.loose_both_white,
      ],
