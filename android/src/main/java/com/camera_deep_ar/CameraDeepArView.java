...
//        activity.addRequestPermissionsResultListener(this);
   ...
   private void initializeDeepAR(){
    ...
    private void initializeFilters() {
        masks = new ArrayList<>();
        masks.add("original_fit_brown");
        masks.add("original_fit_yellow");
        masks.add("original_fit_blue");
        masks.add("original_fit_pink");
        masks.add("original_fit_black");
        masks.add("original_fit_white");

        masks.add("loose_top_brown");
        masks.add("loose_top_yellow");
        masks.add("loose_top_blue");
        masks.add("loose_top_pink");
        masks.add("loose_top_black");
        masks.add("loose_top_white");

        masks.add("loose_bottom_brown");
        masks.add("loose_bottom_yellow");
        masks.add("loose_bottom_blue");
        masks.add("loose_bottom_pink");
        masks.add("loose_bottom_black");
        masks.add("loose_bottom_white");

        masks.add("loose_both_brown");
        masks.add("loose_both_yellow");
        masks.add("loose_both_blue");
        masks.add("loose_both_pink");
        masks.add("loose_both_gray");
        masks.add("loose_both_white");
